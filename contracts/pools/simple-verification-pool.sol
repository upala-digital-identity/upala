...
contract SimpleVerificationPoolFactory {
    ...
    function createPool() external returns (address) {
        address newPoolAddress = address(new SimpleVerificationPool(upalaAddress, approvedTokenAddress, msg.sender));
...
contract SimpleVerificationPool is Ownable {
    ...
    ************/
    ...
    // todo onlyOwner
    function publishScoreBundle(bytes32 newScoreBundle) external  {
        console.log("publishScoreBundle");
